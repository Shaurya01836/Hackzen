...
export default function CreateHackathon({
  ...
  const { token } = useAuth(); // Using AuthContext instead of localStorage
          ...
          {type !== "gallery" && currentImage && (
            <div className="relative">
              ...
              <Button
                ...
                onClick={() =>
                  document.getElementById(`edit-upload-${type}`).click()
                }
                title="Edit image"
              >
              ...
              <CardContent className="space-y-4">
                        ...
                        >
                          ...
                          <TooltipProvider>
                            <Tooltip>
                              ...
                              <TooltipContent className="rounded-lg shadow-lg p-3 bg-white text-gray-800 border border-indigo-100 max-w-xs">
                ...
                {(formData.roundType === "single-round" ||
                  ...
                  <div className="mt-4">
                      ...
                      <CardContent className="space-y-6">
                        {formData.roundType === "multi-round" && (
                          <div className="mb-2 text-blue-700 text-sm flex items-center gap-2">
                            <Info size={16} />
                            Since your hackathon has multiple rounds, please
                            specify the start/end/submission deadlines for each
                            round below.
                          </div>
                        )}
                        {(formData.roundType === "single-round"
                    ...
                    {/* Validation messages */}
                    {formData.roundType === "single-round" &&
                      (!formData.rounds[0]?.name ||
                        !formData.rounds[0]?.description ||
                        !formData.rounds[0]?.startDate ||
                        !formData.rounds[0]?.endDate) && (
                        <div className="text-red-600 text-xs mt-1">
                          All round fields are required.
                        </div>
                      )}
                    {formData.roundType === "multi-round" &&
