...
import {
  ArrowLeft, MessageSquare, Send, Users, Calendar,
  Edit, Trash2, Eye
} from "lucide-react"
import {
...
export function Announcements({ onBack }) {
  ...
  const handleQuickSend = async () => {
    try {
      ...
      setTitle(""); setMessage(""); setAudience(""); setPriority(""); setHackathon("")
      fetchAnnouncements()
    } catch (err) {
      alert(err.message)
    }
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Send announcements and track performance</p>
          </div>
        </div>
      </div>
                ...
                <CardHeader>
                  <div className="flex items-start justify-between">
                    ...
                    <Badge className={`text-white ${
                      ...
                      a.type === 'reminder' ? 'bg-yellow-500' : 'bg-green-500'
                    }`}>{a.type}</Badge>
                  </div>
                </CardHeader>
                <CardContent>
        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Select value={hackathon} onValueChange={setHackathon}>
                  ...
                  <SelectContent>
                    <SelectItem value="all">All Events</SelectItem> {/* ✅ fixed */}
              ...
              <Button onClick={handleQuickSend} className="bg-purple-500 hover:bg-purple-600 text-white">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <span>Last Sent</span>
                <span className="font-medium">{sent[0] ? new Date(sent[0].createdAt).toLocaleString() : "—"}</span>
              </div>
            </CardContent>
          </Card>
        </div>
