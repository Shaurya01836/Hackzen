...
import { Search, Filter, Inbox, Clock, CheckCircle, AlertCircle, Send, MoreHorizontal } from "lucide-react"
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="space-y-3">
            {filteredTickets.map((ticket) => (
              <Card
                key={ticket.id}
                className={`bg-black/20 backdrop-blur-xl border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 cursor-pointer ${
        ...
        <div className="space-y-4">
          {selectedTicket ? (
            <>
              <Card className="bg-black/20 backdrop-blur-xl border-purple-500/20">
                ...
                <CardContent className="space-y-4">
                  <div className="p-4 bg-white/5 rounded-lg border border-purple-500/20">
                    <p className="text-gray-300 text-sm mb-2">Original Message:</p>
                  ...
                  <div className="p-4 bg-blue-500/10 rounded-lg border border-blue-500/20">
                    <p className="text-blue-300 text-sm mb-2">Admin Response:</p>
                    <p className="text-white">
              ...
              <Card className="bg-black/20 backdrop-blur-xl border-purple-500/20">
                <CardHeader>
                  <CardTitle className="text-white text-lg">Reply</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <Textarea
            ...
            <Card className="bg-black/20 backdrop-blur-xl border-purple-500/20">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-400">Select a ticket to view details and reply</p>
              </CardContent>
            </Card>
          )}
        </div>
