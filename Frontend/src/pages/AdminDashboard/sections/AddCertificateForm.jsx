...
export default function AddCertificateForm() {
  ...
  return (
    <div className="min-h-screen  bg-gradient-to-br from-slate-50 via-purple-50 to-slate-50 p-0">
      ...
      {/* Main Form - full width, no card, no max-w, no border, no shadow */}
      <form onSubmit={handleSubmit} className="space-y-8 px-0 pb-16 w-full">
        {/* Basic Information Section */}
        <div className="space-y-6">
          <div className="border-b border-gray-200 pb-4">
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Basic Information</h3>
            <p className="text-gray-600 text-sm">Provide the essential details for your certificate template</p>
          </div>
        ...
        <div className="space-y-6">
          <div className="border-b border-gray-200 pb-4">
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Certificate Preview</h3>
            <p className="text-gray-600 text-sm">Upload an image or provide a URL for the certificate template</p>
          </div>
        ...
        <div className="space-y-6">
          <div className="border-b border-gray-200 pb-4">
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Template Settings</h3>
            <p className="text-gray-600 text-sm">Configure additional options for this certificate template</p>
          </div>
