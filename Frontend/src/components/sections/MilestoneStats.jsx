...
function MilestoneStats() {
  return (
    <section className=" py-12 px-4 sm:px-6 md:px-12 text-[#1b0c3f] ">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-gray-600 text-sm md:text-base mb-6 font-semibold">
          HackZen Milestones
        </h2>
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8 text-center border border-gray-300 py-4 rounded-3xl">
